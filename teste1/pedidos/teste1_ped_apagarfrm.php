...
<html lang="en">
  ...
  <body>
	...
	<div class='container' style='margin-top: 20px'>
		<form action="?go=apagar" method="post">
		<h3>
		<span class="label label-default">Id</span>
		<input type="text" name="id" id="id" maxlength="7"/>
		</h3>
		</br>
		<h4>
	...
	<?php
		if(@$_GET['go']=='apagar'){
			...
			if($ok){
				echo "<script>alert('Pedido apagado com sucesso!');</script>";
			}
			else{
				echo "<script>alert('Pedido não apagado!');</script>";
			}
		}
	?>
