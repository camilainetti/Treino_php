...
<html lang="en">
  ...
  <body>
	...
	<div class='container' style='margin-top: 20px'>
		...
		<span class="label label-default">Preço</span>
		<input type="float" name="preco" id="preco" maxlength="3"/>
		</h3>
		</br></br>
		<h4>
	...
	<?php
		if(@$_GET['go']=='atualizar'){
			...
			$query = "UPDATE produto SET nome='$nome', descricao='$descricao', preco='$preco' ";
